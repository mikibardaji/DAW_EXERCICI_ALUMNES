...
import calculadoracutregui.PanelBotonesLuchador;
import calculadoracutregui.PanelDatosEntrada;
import calculadoracutregui.PanelDeBottones;
import calculadoracutregui.PanelMenuLuchadores;
...
public class FinestraPrincipal extends JFrame {
    ...
    private void initContainer() {
      ...
      principal.setLayout(new BorderLayout());
      //new GridLayout(5,5)
      PanelMenuLuchadores menu = new PanelMenuLuchadores();
      principal.add(menu, BorderLayout.CENTER);
      
      PanelBotonesLuchador botone = new PanelBotonesLuchador();
      principal.add(botone, BorderLayout.EAST);
      /*
      //declaro un panel
