...
//Exercici C2 
     ...
     p1.setDni("12345678A");
        p1.setNombre("Miquel");
        p1.setApellidos("Bardaji");
        p1.setEdad(20);

        p2.setDni("12345678B");
        p2.setNombre("Laura");
        p2.setApellidos("Montesinos");
        p2.setEdad(70);

        p3.setDni("12345678C");
        p3.setNombre("Susana");
        p3.setApellidos("Avila ");
        p3.setEdad(50);
    ...
    //     System.out.println("Persona 3: " + p3.getNombre() + " " + p3.getApellidos() + ", DNI " + p3.getDni() + ", edad " + p3.getEdad());
        ...
        System.out.println("Funcion mayor edad : ");
         System.out.println("¿Miquel es mayor de edad? " + p1.esMayorDeEdad());
        System.out.println("¿Laura es mayor de edad? " + p2.esMayorDeEdad());

        System.out.println("Funcion jubilacion ");
          System.out.println("¿Miquel es jubilado? " + p1.esJubilado());
        System.out.println("¿Laura  es jubilada? " + p2.esJubilado());
