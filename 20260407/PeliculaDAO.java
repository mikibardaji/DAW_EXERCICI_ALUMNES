...
public class PeliculaDAO implements interfaceDAO {
    ...
    addPeli(new Pelicula(1, "Alien", "TERROR", true, 117));
    addPeli(new Pelicula(34, "Alien", "TERROR", true, 118));
    addPeli(new Pelicula(14, "Agarralo como puedas 14", "Comica", true, 95));
    addPeli(new Pelicula(2, "Matrix", "CIENCIA FICCIO", true, 136));
    addPeli(new Pelicula(3, "Salvar al Soldado Ryan", "WESTERN", false, 170));
    addPeli(new Pelicula(4, "Top Secret", "Comica", false, 90));
    addPeli(new Pelicula(4, "Agarralo como puedas", "Comica", true, 88));
    addPeli(new Pelicula(24, "Alien", "TERROR", true, 121));
}
