...
public class Clash_Royale_Llenyataire_versio3 {
    public static void main(String[] args) throws InterruptedException {

        Scanner sc = new Scanner(System.in);
        Random rd = new Random();

        System.out.println("Pon el nivell de tu leñador (9-13): ");
        ...
        if (nivel_lenyador == 9) {
            ...
            System.out.println("Nivell de llenyataire no vàlid!");
            sc.close();
            return;
        }
        ...
        danyo_torre = danyo_torre * 2;

        System.out.println(" El teu llenyataire (nivell " + nivel_lenyador + ") té " + vida_lenyador + " de vida i " + danyo_lenyador + " dany per cop.");
        System.out.println(" La torre enemiga (nivell " + nivel_torre + ") té " + vida_torre + " de vida i " + danyo_torre + " dany per cop (ATAC X2)");
        ...
        while (vida_lenyador > 0 && vida_torre > 0) {
            ...
            System.out.println("Torre respon amb dos atacs! Dany total " + danyo_torre + ". Vida del llenyataire = " + vida_lenyador);
