    ...
    public static void main(String[] args) throws Exception {
        ...
        while (vida_torre > 0 && vida_leñador > 0) {
            ...
            if (vida_torre == 0) 
                ...
                golpes_torre++;
                vida_leñador -= daño_torre * 2;

            if (vida_leñador < 0) {   
                
                System.out.println("La torre dobla su ataque con " + (daño_torre * 2) + ".");
                System.out.println("La torre infringe " + (daño_torre * 2) + " de daño. La vida del leñador es de " + vida_leñador + ".");
                Thread.sleep(500);
